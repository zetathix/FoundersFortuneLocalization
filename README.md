...
###### - **[TH]**  นำไฟล์ทั้งหมดใส่โฟลเดอร์ไปวางในโฟลเดอร์ของเกม และเปลี่ยนชื่อโฟลเดอร์เป็น "**localization**" อย่าลืม **สร้างไฟล์ชื่อ "custom.txt"** ไว้ในโฟลเดอร์ localization โดยที่ข้างในไฟล์นี้ให้เขียนไว้ตามด้านล่าง (อย่าลืมเปลี่ยนบรรทัดสุดท้ายเป็น thai):
